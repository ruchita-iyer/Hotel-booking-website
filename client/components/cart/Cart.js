...
//Cart
  return (
    <>
      <MetaData title={'My booking list'} />

      {cartItems.length === 0 ? <h2 className="mt-5">My booking list is empty</h2> : (
        <>
        <h2 className="mt-5">My booking list: 
          <b>{cartItems.length} booking</b></h2>
